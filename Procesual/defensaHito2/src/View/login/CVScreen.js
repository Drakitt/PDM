...
export default class CVScreen extends Component {
    ...
    _onPress() {
        ...
        if (this.state.busqueda == 'sospechosos') {
            console.log(this.state.busqueda,Math.max(parseInt(this.state.sospechososCocha, 10), parseInt(this.state.sospechososSanta, 10), parseInt(this.state.sospechososOruro, 10)));
        } else if (this.state.busqueda == 'confirmados'){
            console.log(this.state.busqueda,Math.max(parseInt(this.state.confirmadosCocha, 10), parseInt(this.state.confirmadosSanta, 10), parseInt(this.state.confirmadosOruro, 10)));
