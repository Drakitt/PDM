...
const styles = StyleSheet.create({
        ...
        button: { alignItems: 'center', justifyContent: 'center', backgroundColor: '#000', width:'auto',height:'auto',
        height: Constants.DEFAULT_MARGIN_BUTTON, borderRadius: 0, zIndex: 100, },
